...
(function () {
  ...
  if (!document.getElementById('vlad-swap-css')) {
    ...
    s.textContent = [
      ...
      '.vt-list{display:flex;flex-direction:column;gap:6px;max-height:540px;overflow-y:auto;scrollbar-width:thin;scrollbar-color:#c3b795 transparent;padding-right:4px}',
      '.vt-list::-webkit-scrollbar{width:7px}',
      '.vt-list::-webkit-scrollbar-track{background:transparent}',
      '.vt-list::-webkit-scrollbar-thumb{background:#c3b795;border-radius:99px}',
      '.vt-list::-webkit-scrollbar-thumb:hover{background:#a8996f}',
